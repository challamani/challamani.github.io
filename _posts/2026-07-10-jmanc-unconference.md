...
AI can write code fast and often surprisingly well. But it doesn't have the lived experience of sitting in a production incident at 2am, or understanding why a particular business decision was made three years ago. That context and wisdom still lives with us. The question worth asking is: **how do we make sure we don't lose it?**
...
The answers were brilliant. Someone said **plumbing**. Another said **electrician**. Trades that AI simply cannot do remotely. Hands-on, physical, always in demand. There's a quiet wisdom in that.
...
There's something genuinely appealing about that kind of simplicity, especially at the end of a day where almost every conversation had circled back to AI reshaping everything we know. Sometimes the most radical Plan B is to step outside the system entirely.
